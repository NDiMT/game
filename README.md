...
- Πόροι: **5 Plays** ανά γύρο· **1 δωρεάν Discard κάθε γύρο** (δεν μαζεύεται) και **5 Discards για όλο το run** (πετάς όσα φύλλα θέλεις,
...
χρωμάτων (SVG 7×7 σε `crispEdges`), scanlines, γραμματοσειρές **Pixelify Sans** (τίτλοι, κείμενο)
...
(`215 → 46 900`, άνοδος ~×1,19 ανά ante έως το 20 και ~×1,1 μετά, σφιγμένη ~20% στη μέση) προέκυψαν από το διάμεσο σκορ του finisher bot ανά
