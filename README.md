...
- Ξεκινάς με μία **Chisel**. Στο κατάστημα **κρατάς έως 2 φύλλα** από το χέρι σου για τον
  επόμενο γύρο (αναβάθμιση Pocket: +1).
...
| --- | --- |
| Pairs+ (και τα πολλαπλά ζευγάρια) · Trips+ · Stairs+ · Straights+ · Full Houses+ · Bombs+ (έως ×3), Extra Play (έως 7), Breath, Discard, Chisel, Wide Hand, Pocket, Head Start, Cull | **Gold** ×2 · **Glass** ×3 και σπάει · **Wild** · **Steel** (πάντα στο αρχικό χέρι) |
