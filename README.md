...
- **Σκορ = Chips × Mult** (όπως στο Balatro). Κάθε σχήμα φέρνει τα δικά του:
  **Pair** 30 × 2 · **Pairs** (2/3/4 ζευγάρια) 40 × 3 / 60 × 4 / 80 × 5 · **Trips** 50 × 4 ·
  **Stairs** (συνεχόμενα ζευγάρια, 22 33 44) 60 × 5 / 85 × 6 / 110 × 7 · **Straight** 5+ φύλλων
  70 × 6 / 90 × 7 / 110 × 8… · **Full House** 90 × 8 · βόμβες: **Quads** 120 × 10 ·
  **Straight Flush** 160 × 14 (+35 chips, +2 mult ανά επιπλέον φύλλο).
...
- Κάθε χέρι **παίζεται**. Αν **χτυπάει το προηγούμενο** — ανώτερος τύπος (Pair < Pairs < Trips <
  ...
  ψηλότερη αξία, ή μακρύτερη κέντα / σκάλα — η **αλυσίδα ανεβαίνει: +2 Mult ανά σκαλί**.
...
**Kingmaker** (Ace in the Hole σκοράρει 60 ανά σκαλί) · **Afterburner** (το χέρι μετά από βόμβα ×3) — και κλειδωμένα με επιτεύγματα ζωής:
...
(`500 → 118 000`, ξαναβαθμονομημένοι για το Chips × Mult) προέκυψαν από την ουρά p10 του
finisher bot ανά ante, διαιρεμένη με λόγο-στόχο που πέφτει από 2,1 (ante 1) σε 1,0 (ante 21)
και 0,62 (ante 30): η δυσκολία ακολουθεί την κλιμάκωση του παίκτη μέσω του καταστήματος,
χωρίς γκρεμό, και οι θάνατοι πυκνώνουν προς το τέλος.
Finisher bot (60 runs): **2% νίκες**, μέσος θάνατος στο ante 18,4, θάνατοι 0–3 ανά ante στο
πρώτο μισό και 3–6 στο δεύτερο, λόγος σκορ/στόχου p50 ≈ 4 στην αρχή, ≈ 2,5 στη μέση, ≈ 1 στο
τέλος. Ο άνθρωπος υπολογίζεται σαφώς καλύτερος από το bot (σχεδιάζει discards και κράτημα
χεριού): ζητούμενο, η κορυφή να είναι σπάνια.
