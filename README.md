...
- Πόροι: **5 Plays** και **2 Breaths** ανά γύρο· **5 Discards για όλο το run** (πετάς όσα φύλλα θέλεις,
...
(`215 → 42 600`, άνοδος ~×1,19 ανά ante έως το 20 και ~×1,1 μετά, σφιγμένη ~20% στη μέση) προέκυψαν από το διάμεσο σκορ του finisher bot ανά
