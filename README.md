...
- Πόροι: **5 Plays** ανά γύρο· **Discards χωρίς όριο, αλλά κάθε ένα κοστίζει 1 Play** (½ με Nimble Hands, 0 με δύο· το πρώτο δωρεάν με Sleight / Spare Card / Four Plays) (πετάς όσα φύλλα θέλεις,
  τραβάς νέα)
...
- **Τράπουλες:** Classic · **Wild Deck** (4 Joker, discards ½ play, οι Joker σκάνε διπλά συχνά — ξεκλειδώνει στο ante 10) ·
...
- **Table rules:** στα ~75% των antes χωρίς challenge ισχύει ένας μικρός κανόνας (seeded): Red Night /
  ...
  (×2 σε κέντες / τρίο / φουλ), Underdogs (×2 σε χέρια με κορυφή ≤ 6), Spare Card (πρώτο discard δωρεάν).
...
(`215 → 96 900`, ξαναβαθμονομημένοι μετά τις τυχαίες ενισχύσεις και το ένα discard ανά γύρο) προέκυψαν από το διάμεσο σκορ του finisher bot ανά
