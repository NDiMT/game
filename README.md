...
- Πόροι: **5 Plays** ανά γύρο· **1 Discard κάθε γύρο**, ακριβώς (δεν μαζεύεται, δεν αγοράζεται) (πετάς όσα φύλλα θέλεις,
  τραβάς νέα)
...
- **Table rules:** στα ~75% των antes χωρίς challenge ισχύει ένας μικρός κανόνας (seeded): Red Night /
  ...
  (×2 σε κέντες / τρίο / φουλ), Underdogs (×2 σε χέρια με κορυφή ≤ 6), Spare Card (+1 φύλλο στο χέρι).
