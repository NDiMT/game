...
(function () {
  ...
  function sheetHowTo() {
    ...
    openS('<h2>How to play</h2><div class="rulz" style="margin-top:.6rem;font-size:.9rem">' +
      ...
      '<p><b>One round, five plays, three discards.</b> Pick cards from your hand, make a hand, play it. You draw back up to eight after every play. Reach the target before the plays run out — <b>the moment you reach it the round is over</b> and the next ante starts on its own.</p>' +
      ...
      '<p><b>Discards</b> are their own resource — three a round, they never cost you a play. Throw any number of cards and draw the same number back. Once your discards are spent, a hand that makes no combination at all still gets one free.</p>' +
      '</details>' +
