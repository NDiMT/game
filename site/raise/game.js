...
(function (root, factory) {
  ...
  /* ×1,02 πάνω στον πίνακα της επαναφοράς (972 → 126 000). Ο μόνος σκοπός του είναι ο ρυθμός
     θανάτου: με τη βόμβα δεμένη στην αλυσίδα (bombChain) το bot πέθαινε στο ante 17,0 και ο
  ...
  const TARGETS = [991, 1210, 1350, 1830, 2190, 2350, 2980, 3340, 3410, 4040, 4410, 4640, 5480, 6350, 6750, 7990, 8890, 9240, 10400, 11300, 11600, 13700, 14700, 15300, 18100, 20000, 20500, 24000, 25900, 26500, 29900, 31800, 34300, 39700, 41900, 43500, 50000, 54000, 55300, 62300, 66400, 67900, 76900, 81200, 83200, 95900, 98400, 103000, 125000, 129000];
  const CFG = {
    ...
    bombMul: 1.55, bombChain: 2, bombCold: 1.15,
