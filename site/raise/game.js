...
(function (root, factory) {
  ...
  const POOL = [
    ...
    { id: "di", name: "Discards", desc: "+2 discards for the rest of the run.", cost: 7 },
  ...
  function buy(S, i) {
    ...
    if (o.kind === "card") { const c = Object.assign({ id: S.nextId++ }, o.card); S.deck.push(c); S.fresh = (S.fresh || []).concat(c.id); trimKeep(S); }
