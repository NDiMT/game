...
Επιλέγεται στο μενού και αποθηκεύεται. Ορίζεται στο `js/levels.js` (`DIFFICULTIES`).

| | Μπάλες | Μέγεθος στόχων | Ταχύτητα κίνησης | Αέρας | Προεπισκόπηση τροχιάς | Πόντοι |
|---|---|---|---|---|---|---|
| 🙂 Εύκολο | +2 | x1.2 | x0.75 | x0.5 | πλήρης | x0.75 |
| 😀 Κανονικό | — | x1 | x1 | x1 | πλήρης | x1 |
| 😈 Δύσκολο | -2 | x0.85 | x1.35 | x1.4 | 4 κουκκίδες | x1.5 |
